...
\newenvironment{envdati}{ % “大题” 环境
  \newcommand {\dati}[1] { % 大题的标题
    \stepcounter{cntdati}
    \hspace{-2.8em}\textbf{\chinese{cntdati}、 ##1} % 一、二、三、……
  }
}{%
}
...
\newenvironment{envzhongti}{ % “中题” 环境
  \newcommand {\zhongti}[1] { % 中题的标题
    ...
    \hspace{-2.8em}（\chinese{cntzhongti}） ##1 %（一）（二）（三）……
  }
}{%
}
...
\newenvironment{envxiaoti}{ % “小题” 环境
  \newcommand {\xiaoti}[1] { % 小题的标题
    ...
    \hangafter 1\setlength{\hangindent}{3.2em}{\arabic{cntxiaoti}. ##1} % 1. 2. 3. ……
  }
}{%
}
...
\newenvironment{envxiaoxiaoti}{ % “小小题” 环境
  \newcommand {\xiaoxiaoti}[1] { % 小小题的标题
    ...
    \hangafter 1\setlength{\hangindent}{5.4em}{\hspace{1em}（\arabic{cntxiaoxiaoti}）##1} % （1） （2） （3） ……
  }
}{%
}
...
\newenvironment{envweiti}{ % “微题” 环境
  \newcommand {\weiti}[1] { % 微题的标题
    ...
    \hangafter 1\setlength{\hangindent}{5.4em}{\hspace{3em}\circled{\arabic{cntweiti}}##1} %  ①  ②  ③ 	 ……
  }
}{%
}
