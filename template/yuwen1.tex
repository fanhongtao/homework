...
\newcommand{\twoInRow}  [2] {\begin{math} \begin{cases} \text{#1}\\ \text{#2} \end{cases}\end{math}}
\newcommand{\threeInRow}[3] {\begin{math} \begin{cases} \text{#1}\\ \text{#2}\\ \text{#3} \end{cases}\end{math}}
\newcommand{\fourInRow} [4] {\begin{math} \begin{cases} \text{#1}\\ \text{#2}\\ \text{#3} \\ \text{#4} \end{cases}\end{math}}
