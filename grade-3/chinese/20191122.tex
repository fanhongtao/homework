...
% 四个一行
\newcommand{\sigeyihang}[4]{\begin{tabular}[t]{*{4}{@{}p{10em}}}
  #1 & #2 & #3 & #4
\end{tabular}}
...
%  
%  装\CJKunderdot{载} （zǎi \kbai zài） \kbai[4em] 海\CJKunderdot{参} （cān \kbai shēn） \kbai[3em] 胳\CJKunderdot{臂} （bì \kbai bei） \\
%  \CJKunderdot{凌} （líng \kbai lín）乱 \kbai[3.5em] 根\CJKunderdot{茎} （jīn \kbai jīng） \kbai[3.8em] 玫\CJKunderdot{瑰} （guī \kbai guì）
...
\xiaoxiaoti{
  ...
  \end{tabular}
%  蟋\CJKunderdot{蟀}（suài \kbai shuài） \kbai[2.4em] \CJKunderdot{材} （cái \kbai chái）料 \kbai[3.5em] \CJKunderdot{搭} （dā \kbai tǎ）船 \\
%  \CJKunderdot{沾}（zhān \kbai[0.1em] zhàn）水 \kbai[3em] \CJKunderdot{钓} （diào \kbai gōu）鱼 \kbai[2.8em] \CJKunderdot{增} （zēn \kbai zēng）加
}
...
\xiaoti{\xuanzeti{下列词语中加点字读音完全正确的一项是}}
...
\xiaoti{\xuanzeti{下面加点字读音有错误的一项是}}
...
\xiaoti{\xuanzeti{下列词语中加点字读音全部正确的一项是} \\
...
\xiaoti{\xuanzeti{以下选项中，字音和字形都没有错误的一项是} \\
...
\xiaoti{\xuanzeti{下面成语中有错别字的一组是} \\
  \onech{\sigeyihang{摇头晃脑}{张牙舞爪}{提心吊胆}{眼疾手快}}
    ...
    %{\begin{tabular*}{35em}[t]{*{4}{@{\extracolsep{\fill}}l}} a&b&c&d \end{tabular*}}
    %{\begin{tabular}[t]{*{4}{p{10em}}} a&b&c&d \end{tabular}}
    %{\begin{tabular}[t]{*{4}{@{\hspace{1em}}l}} a&b&c&d \end{tabular}}
    % {\begin{tabular}[t]{*{4}{p{10em}}l} a&b&c&d& \end{tabular}}
    %{\begin{tabular}[t]{*{4}{@{}p{10em}}} a&b&c&d \end{tabular}}
    %{\begin{tabular}[t]{*{4}{l}} a&b&c&d \end{tabular}}
    %{\begin{tabbing}a\hspace{3em}  \= b\hspace{3em} \= c\hspace{3em} \= d\end{tabbing}}
}
