...
% 直接使用 \fourInLine 会有告警信息，所以这里重新定义一个命令，
% 将第4个项放置在表格外，这样减少了一行的总长度，消除告警。
\newcommand{\fline}[4] {\threeInLine[11em]{#1}{#2}{#3}#4}

\fline{眉\kh 目\kh}{\kh\kh 玉立}{明\kh\kh 齿}{文质\kh\kh}

\fline{相貌\kh\kh}{威风\kh\kh}{\kh 大\kh 圆}{\kh\kh 精悍}

\fline{容\kh 焕\kh}{\kh 发童\kh}{\kh 眉\kh 目}{老态\kh\kh}

\zhongti{照样子，在括号里填上合适的词语。}

\xiaoti{ \threeInLine{（优美）的风景}{\kh[1cm]的豆荚}{\kh[1cm]的牙齿}}

\xiaoti{ \threeInLine{（剧烈）地抖动}{\kh[1cm]地移动}{\kh[1cm]地避开}}

\xiaoti{ \threeInLine{（抄写）文章}{\kh[1cm]生活}{\kh[1cm]奇迹}}
...
\xiaoti{得知普罗米修斯从天上取走火种的消息，众神的领袖宙斯气急败坏，决定给普罗米修斯以最\\（严肃 \kbai 严厉）的惩罚，吩咐火神立即执行。}
...
\fourInLine{人声 \kh 沸}{锣鼓 \kh 天}{\underline{三头六 \kh}}{震耳 \kh 聋}

\fourInLine{\kh 声细语}{\CJKunderwave{秉公 \kh 法}}{鸦 \kh 无声}{\kh 无声息}
